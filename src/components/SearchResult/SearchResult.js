    ...
    render() {
        return (
            <div className="result">
                <h3 className="result-title"><a href={this.props.url} target="_blank" rel="noopener noreferrer" dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(this.props.title)}}></a></h3>
